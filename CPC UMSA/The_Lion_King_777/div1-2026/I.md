...
So the **KEY IDEA** for this problem was to do MORE DIVERGENT THINKING **(GENERATING PATTERNS) and TESTING IF THEY ARE A GOOD FIT (straight to the point, wihtout "too much forcing/ACCOMODATION**").
