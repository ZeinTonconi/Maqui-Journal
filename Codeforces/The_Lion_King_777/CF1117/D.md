...
* Un problema de implementacion tiene que ver con **NO PASAR LA LOGICA DEL ALGORITMO CORRECTAMENTE HACIA EL LENGUAJE DE PROGRAMACION**, es decir, si el codigo NO CORRE en la maquina, puede ser porque la logica esta mal, o la implementacion (de acuerdo a las especificaciones y reglas del lenguaje y la maquina) esta mal (o la logica esta "mal copiada").
